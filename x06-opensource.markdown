...
Mechanical and electrical files for the CubeSat Antenna can be found on CFAR's [GitLab repo](https://gitlab.uvic-cfar.com/orcasat-group/orcasat-antenna).
...
Mechanical drawings can be found on CFAR's [GitLab repo](https://gitlab.uvic-cfar.com/orcasat-group/ground-station-crossboom).

## HF Turnstile Antenna

An circulaly polarized HF turnstile antenna design has been realized as part of the MARMOTSat project, to support space communications and HF NVIS operations up to legal limit transmit power in the the 10m HF band. A prototype of the antenna has been built and it is part of the lab's HF antenna farm.

Mechanical drawings can be found on CFAR's [GitLab repo](https://gitlab.uvic-cfar.com/open-source-projects/hf-turnstile-antenna).